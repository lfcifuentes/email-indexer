    ...
    <ul class="inline-flex -space-x-px text-sm">
      <li>
        <button
          ...
          class="flex items-center justify-center px-3 h-8 ms-0 leading-tight text-gray-500 bg-white border border-e-0 border-gray-300 rounded-s-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-t-purple dark:hover:text-white"
          :class="{
      ...
      <li>
        <button
          ...
          class="flex items-center justify-center px-3 h-8 ms-0 leading-tight text-gray-500 bg-white border border-e-0 border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-t-purple dark:hover:text-white"
          :class="{
            'cursor-not-allowed': meta?.current_page === 1,
            'cursor-pointer': meta?.current_page !== 1
          }"
      ...
      <li v-for="link in pageLinks" :key="link.label">
        <button
          ...
          :class="{
            'text-white border-gray-300 bg-t-purple hover:bg-blue-100 hover:text-blue-700 dark:border-gray-700 dark:bg-t-light-purple dark:text-white dark:hover:bg-t-purple dark:hover:text-white': link.active,
            'text-gray-500 bg-white border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-t-purple dark:hover:text-white cursor-pointer' : !link.active
          }"
      ...
      <li>
        <button
          ...
          class="flex items-center justify-center px-3 h-8 ms-0 leading-tight text-gray-500 bg-white border border-e-0 border-gray-300 rounded-e-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-t-purple dark:hover:text-white"
          :class="{
            'cursor-not-allowed': meta?.current_page === meta.last_page,
            'cursor-pointer': meta?.current_page !== meta.last_page
          }"
